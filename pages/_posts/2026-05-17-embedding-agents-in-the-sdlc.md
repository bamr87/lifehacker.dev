...
In the [Agentic Codex arc](https://it-journey.dev/quests/gh-600/agentic-observability-and-control/), this is implemented using workflow step summaries and structured JSONL log files committed back to the repository.

## Domain 1 Quests

| Quest | Skill | Link |
|---|---|---|
| Q1 | SDLC Integration | [Agentic SDLC Integration](https://it-journey.dev/quests/gh-600/agentic-sdlc-integration/) |
| Q2 | Plan vs Action | [Plan vs Action Boundaries](https://it-journey.dev/quests/gh-600/agentic-plan-vs-action-boundaries/) |
| Q3 | Observability | [Observability & Control](https://it-journey.dev/quests/gh-600/agentic-observability-and-control/) |

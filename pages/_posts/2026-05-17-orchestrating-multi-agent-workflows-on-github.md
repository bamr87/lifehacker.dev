...
jobs:
  orchestrate:
    outputs:
      task_a_result: {% raw %}${{ steps.a.outputs.result }}{% endraw %}
...
| Quest | Skill | Link |
|---|---|---|
| Q14 | Orchestration Patterns | [Multi-Agent Orchestration Patterns](https://it-journey.dev/quests/gh-600/agentic-multi-agent-orchestration-patterns/) |
| Q15 | Multi-Agent Observability | [Multi-Agent Observability](https://it-journey.dev/quests/gh-600/agentic-multi-agent-observability/) |
| Q16 | Failure Recovery | [Multi-Agent Failure Recovery](https://it-journey.dev/quests/gh-600/agentic-multi-agent-failure-recovery/) |
| Q17 | Lifecycle Management | [Multi-Agent Lifecycle Management](https://it-journey.dev/quests/gh-600/agentic-multi-agent-lifecycle-management/) |

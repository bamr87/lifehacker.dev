...
description: "A workflow that commits and pushes can fire the event that started it and run forever. I tested four skip-guards against a human named Robott Bottomley. Only one held."
date: 2026-08-12

...
internet. Putting the database reachable from public subnets is how you accidentally expose it. This is a data-exposure footgun, not a performance tip.
- **Cold starts.** In this era, attaching a Lambda to a VPC added real cold-start
latency while it provisioned an elastic network interface. VPC endpoints helped. This was the single most surprising tax on the whole setup, and it's the thing I cannot re-measure for you here.

...
preview: /images/previews/what-gpt-4-saw-in-my-cv-an-ai-career-analysis-fiel.jpg
---
...
1. **Be more concise.** Detailed is not the same as readable.
2. **Quantify achievements.** "Led an ERP migration" is a sentence; "led an ERP migration that cut close time from 12 days to 5" is evidence.
3. **Make LinkedIn match the CV.** Two documents that disagree about your career make a recruiter trust neither.

...
date: 2024-05-14
categories: [jekyll]
tags: [jekyll, sidebar, liquid, navigation]
author: bamr87
excerpt: "A Jekyll sidebar implementation that lists files and folders from a collection, with hyperlinks and dynamic navigation using Liquid templating."
draft: true
---
{% raw %}

...
description: "How build.sh reproduces GitHub Pages safe mode by cloning the theme and throwing away the seven plugins that make it nice — the one build path local and CI share."

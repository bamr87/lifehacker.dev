...
description: "ripgrep (rg) versus grep: what makes it worth switching, the one default that will confuse you, when plain grep is still right, and what it costs."
date: 2026-06-22
collection: tools
author: claude

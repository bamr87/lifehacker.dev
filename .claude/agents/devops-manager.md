...
Follow the **devops-manager skill**. Run the deterministic audit (`scripts/devops/audit.rb`) + the E2E simulation, then add judgment: propose and apply safe pipeline improvements and open ONE PR.
